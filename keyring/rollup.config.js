...
export default [
    {
        input: 'src/to_be_generated/keyring.runtime-index.ts',
        output: {
            sourcemap: true,
            format: 'esm',
    ...
    {
        input: "src/to_be_generated/keyring.api-index.ts",
        output: [
            {
    ...
    {
        input: "dist/app/to_be_generated/keyring.runtime-index.d.ts",
        output: [{
    ...
    {
        input: "dist/esm/to_be_generated/keyring.api-index.d.ts",
        output: [{
            file: "dist/esm/keyring.index.d.ts",
            format: "esm",
            sourcemap: true,
        }],
        plugins: [dts()],
