...
export default [
    {
        input: 'src/to_be_generated/sso.runtime-index.ts',
        output: {
            sourcemap: true,
            format: 'esm',
    ...
    {
        input: "src/to_be_generated/sso.api-index.ts",
        output: [
            {
    ...
    {
        input: "dist/app/to_be_generated/sso.runtime-index.d.ts",
        output: [{
    ...
    {
        input: "dist/esm/to_be_generated/sso.api-index.d.ts",
        output: [{
            file: "dist/esm/sso.index.d.ts",
            format: "esm",
            sourcemap: true,
        }],
        plugins: [dts.default()],
